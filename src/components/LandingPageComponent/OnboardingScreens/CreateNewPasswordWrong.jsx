...
function CreateNewPasswordWrong() {
  return (
    <div className="onboardingcontainer">
      ...
      <p>Please ensure your new pass is something you
        can remember easily. It must be at least 8 characters
...
export default CreateNewPasswordWrong;